...
void setup() {
  ...
  //output = createWriter( "posicao_50cm_5nos.csv" ); //Cria o objeto arquivo para gravar os dados
  //output = createWriter( "posicao_1m_5nos.csv" ); //Cria o objeto arquivo para gravar os dados
  output = createWriter( "posicao_2m_5nos.csv" ); //Cria o objeto arquivo para gravar os dados
  //output = createWriter( "posicao_3m.csv" ); //Cria o objeto arquivo para gravar os dados
  //output = createWriter( "posicao_4m.csv" ); //Cria o objeto arquivo para gravar os dados
